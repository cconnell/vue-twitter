<template>
  <div>
    ...
    <input type="text" class="form-control m-b-15" placeholer="Username" v-model="user.username">
    <input type="password" class="form-control" placeholer="Password" v-model="user.password">
