<template>
  <div>
    ...
    <input type="text" class="form-control m-b-15" placeholder="User Name" v-model="user.username">
  ...
  export default {
    ...
    methods: {
      register: function() {
        ...
        .then(function (res) {
          alertify.success("You're uccessfuly registered. You can login with your email and password.");
